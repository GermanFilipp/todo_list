...
list($all_project,$all_task) = start();
?>
<html>
<head>
    <meta charset="utf-8">
...
<div class="container" style="height:500px;padding-top:50px;">
    ...
    <div class="form_add display_none col-md-offset-2" style="padding:5px 5px 30px 5px;width:600px;">
        <table>
            <tr  class="tr_table_task color_white font_size_14"  style="width:700px;">
                <td><img src="image/image_tr_project.png" /></td>
                ...
                <td> <button class="btn btn-success background_button" style="padding-top:5px;" id="save_todo">Save</button></td>
            </tr>
        </table>
    </div>
    ...
    <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <button type="button" class="btn btn-primary delete_task">Yes</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary update_task">Save</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <? foreach($all_project as $value){?>
            ...
            <table class="table table_js<?= $value['id'] ?> table-hover" data-project-id="<?= $value['id'] ?>" data-project-descr="<?= $value['name'] ?>" style="background: #fff;">
                <tr class="tr_table_task color_white font_size_14">
                    ...
                    <td>
                        <a href="#" class="delete_project color_project pull-right margin_right_left" style="color: #ddd;margin: 5px;"><i class="glyphicon glyphicon-trash"></i> </a>
                        <a href="#" data-toggle="modal" data-target="#myModal" class="edit_project color_project pull-right" style="color: #ddd;margin: 5px;"><i class="glyphicon glyphicon-pencil"></i> </a>
                    </td>
                </tr>
                <tr class="tr_table_add_task">
                    <td><img src="image/image_add_task.png" /></td>
                    <td colspan="2">
                        ...
                        <tr  class="data_tr_<?= $value_task[$value['id']]['id_task'] ?> style_for_task"  data-id-task="<?= $value_task[$value['id']]['id_task'] ?>" >
                            ...
                            <td   colspan="2" class="border_td" ><span class="name_task"  <?= $value_task[$value['id']]['status']==1 ? 'style="text-decoration:line-through"' : '' ?>><?= $value_task[$value['id']]['descr'] ?> </span>
                                <div class="pull-right">
                                    <a href="#" onclick="return false;" class="prew color_td color_edit"><i class="glyphicon glyphicon-chevron-up"></i></a>
                                    <a href="#" onclick="return false;" class="next color_td color_edit"><i class="glyphicon glyphicon-chevron-down"></i></a>
                            <a data-toggle="modal" href="#" class="update color_td color_edit" data-target="#myModal" data-task-descr="<?= $value_task[$value['id']]['descr'] ?>"><i class="glyphicon glyphicon-pencil"></i> </a>
                                <a href="#" data-toggle="modal" class="delete color_td color_edit" data-target=".bs-example-modal-sm"><i class="glyphicon glyphicon-trash"></i> </a>
                                    </div>
                            </td>
                        </tr>
                    <? } ?>
