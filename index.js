...
function exchange(id_first, id_second, type) {
    $.ajax({
        ...
        dataType: "json",
        url: "exchange_task.php",
        success: function() {
            switch(type) {
                case 1: $('.data_tr_'+id_first).before($('.data_tr_'+id_second));break;
                case 2: $('.data_tr_'+id_first).after($('.data_tr_'+id_second));break;
            }
...
//script's to load page
$( document ).ready(function() {

    //show modal window to udate
